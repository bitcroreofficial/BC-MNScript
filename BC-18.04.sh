#!/bin/bash
# BitcroreCoin Masternode Setup Script V1.0 for Ubuntu 18.04 LTS
#
...
wget https://github.com/bitcroreofficial/BitcroreCoin/releases/download/v1.0/Bitcrore-daemon-ubuntu-18.04.tar.gz
tar -xzvf Bitcrore-daemon-ubuntu-18.04.tar.gz
